...
assert(w == h, sprintf('Assertion failed: w (%d) is not equal to h (%d)', w, h));
assert(2^nextpow2(w) == w, sprintf('Assertion failed: 2^nextpow2(w) (%d) is not equal to w (%d)', 2^nextpow2(w), w));
